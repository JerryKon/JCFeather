//this jcFeather_rachis shader has nothing different with jcFeather.sl. This will only make rachis colored with jcFeaColorTex.
...
surface jcFeather_rachis(float jcFeaAmb = .5 ,
						 jcFeadiff = 0.6, 
						 jcFeaspec = .8, 
						 jcFeagloss = .07,
						 jcFeaselfshad=1,
